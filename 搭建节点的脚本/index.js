...
const SUB_PATH = process.env.SUB_PATH || 'diaomao';       // 订阅sub路径，默认为sub,例如：https://google.com/sub
const UUID = process.env.UUID || 'dc768f60-de16-4128-842f-af2490286fe3';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
